  ...
  <div class="container-fluid mt-5">
    <section class="card wow fadeIn" style="background-image: url(<?php echo base_url();?>assets/img/bg4.jpg);background-attachment: fixed; background-position: center; background-repeat: no-repeat; background-size: cover; height: 300px;">
      <div class="card-body text-white text-center py-5 px-5 my-5">
        <h1 class="mb-4"><strong>Support</strong></h1>
        <p><strong>We would love to assist you.</strong></p>
      </div>
    </section>
    <hr class="my-5">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-8">
          ...
          <div class="news-data">
            ...
            <button class="btn btn-primary waves-effect " type="submit">Send mail</button>
          </div>
          <?php echo form_close(); ?>
        </div>
      </div>
