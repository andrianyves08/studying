<header>
  <nav class="wow fadeIn d-flex navbar">
      <a class="navbar-brand waves-effect" href="<?php echo base_url(); ?>">
        <picture>
            <source media="(max-width: 1700px)" srcset="<?php echo base_url();?>assets/img/logo-1.png">
            <img src="<?php echo base_url();?>assets/img/logo.png" class="img-fluid" alt="" style="height: 40px;">
        </picture>
      </a>
