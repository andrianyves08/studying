...
<head>
  ...
  <?php if ($title == 'Post') { ?>
    <meta name="keywords" content="<?php foreach ($meta_keywords as $meta_keyword) { echo ucfirst($meta_keyword['keywords_name']).',';} ?>" />
  <?php } else {?>
    <meta name="keywords" content="<?php echo ucfirst($meta_description); ?>" />
  <?php } ?>
  <!-- Font Awesome -->
...
@font-face {
  font-family: "Roboto";
  src: 
/*  url('<?php echo base_url();?>assets/font/roboto/AstrWl3o.otf') format('opentype'),*/
